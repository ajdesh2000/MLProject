...
class trainTask2():
	...
	def train(self):
		...
		if(relearn):
			epsilon = 0.01
			self.a_model.load_weights('task2_a_model.h5') #Loading weights for continued learning
			self.c_model.load_weights('task2_c_model.h5')
		...
		self.a_model.save_weights('task2_a_model.h5')
		self.c_model.save_weights('task2_c_model.h5')
